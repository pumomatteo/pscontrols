...
class LoaderManager {
  static show(element, transparency = true, tag, text) {
    this.addCss();
    if (tag == null)
      tag = "vrLoadingTemp";
    ...
    background.setAttribute("style", "position:	absolute; left: " + loaderElement.scrollLeft + "px; top: " + loaderElement.scrollTop + "px;	z-index: " + zIndex.toString() + "; background-color: #FFF; opacity: " + opacity + "; width: " + backgroundWidth + "; height: " + backgroundHeight + ";");
